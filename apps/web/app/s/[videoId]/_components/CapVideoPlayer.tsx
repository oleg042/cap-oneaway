...
export function CapVideoPlayer({
	...
	const rawPlaybackBadgeDescription =
		uploadProgressRaw?.status === "error"
			...
			: "This page is temporarily playing the original uploaded file while Tape finishes processing the optimized version for smoother playback and broader compatibility.";
